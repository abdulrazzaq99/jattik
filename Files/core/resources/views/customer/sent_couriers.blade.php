                            ...
                            <tbody>
                                @forelse($couriers as $courier)
                                    <tr>
                                        ...
                                        <td>
                                            <div>
                                                <strong>{{ $courier->receiverCustomer->fullname ?? 'N/A' }}</strong><br>
                                                <small class="text-muted">{{ $courier->receiverCustomer->mobile ?? 'N/A' }}</small>
                                            </div>
                                        </td>
                                        <td>
                                            {{ $courier->receiverBranch->name ?? 'N/A' }}
                                        </td>
                                        <td>
                                            @if($courier->status == 0)
                                    ...
                                    <tr>
                                        <td colspan="6" class="text-center">
                                            <div class="py-5">
                                                ...
                                                <h5 class="mt-3 text-muted">@lang('No Sent Couriers')</h5>
                                                <p class="text-muted">@lang('You have not sent any couriers yet.')</p>
                                            </div>
                                        </td>
                                    </tr>
                                @endforelse
