                ...
                <div class="col-xxl-5 col-xl-6 col-lg-7 col-md-8">
                    <div class="account-card">
                        <div class="account-card__header bg--base text-center">
                            ...
                            <h4 class="account-card__title text-white mt-3 mb-0">@lang('Verify OTP')</h4>
                            <p class="text-white mt-2">
                                @lang('We sent a 6-digit code to your') <strong>{{ $registrationData['otp_method'] == 'email' ? $registrationData['email'] : $registrationData['mobile'] }}</strong>
                            </p>
                        </div>
                        <div class="account-card__body">
                            <form action="{{ route('customer.register.verify.post') }}" method="POST" class="disableSubmission">
                                @csrf
                                ...
                                <div class="form-group">
                                    <button type="submit" class="btn cmn--btn w-100">@lang('Verify & Complete Registration')</button>
                                </div>

                                <div class="text-center">
                                    <p class="mb-2">@lang("Didn't receive the code?")</p>
                                    <form action="{{ route('customer.register.resend') }}" method="POST" class="d-inline">
                                        @csrf
                                ...
                                <p class="text-center mb-0">
                                    <a href="{{ route('customer.register') }}" class="text--base">
