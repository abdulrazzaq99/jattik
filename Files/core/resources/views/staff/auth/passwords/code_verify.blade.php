            ...
            <div class="login-area">
                <div class="text-center mb-3">
                    ...
                    <p class="text-white mb-2">
                        @lang('Please check your email and enter the verification code you got in your email.')
                    </p>
                </div>
                <form action="{{ route('staff.password.verify.code') }}" method="POST" class="login-form w-100">
                    ...
                    <div class="d-flex flex-wrap justify-content-between">
                        <a href="{{ route('staff.password.request') }}" class="forget-text">
                            @lang('Try to send again')
                        </a>
                    </div>
                    <button type="submit" class="btn cmn-btn w-100 mt-4">@lang('Submit')</button>
                </form>
                <a href="{{ route('staff.login') }}" class="text-white mt-4">
