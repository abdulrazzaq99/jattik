...
@endphp
<section class="service-section pt-120 pb-120 bg--title-overlay bg_fixed bg_img"
    data-background="{{ frontendImage('service', @$serviceContent->data_values->background_image, '1920x1080') }}">
    <div class="container position-relative">
        <div class="section__header section__header__center text--white">
            <span class="section__cate">{{ __(@$serviceContent->data_values->title) }}</span>
            <h3 class="section__title">{{ __(@$serviceContent->data_values->heading) }}</h3>
                ...
                <div class="col-md-6 col-sm-10 col-lg-4">
                    <div class="service__item">
                        <div class="service__item-thumb">
                            <img src="{{ frontendImage('service', $serviceElement->data_values->image, '128x128') }}"
                                alt="service image">
                        </div>
