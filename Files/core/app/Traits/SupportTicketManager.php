...
trait SupportTicketManager
{
    ...
    public function supportTicket()
    {
        ...
        return view(($this->userGuard ?? "Template::$this->userType") . '.support.index', compact('supports', 'pageTitle'));
    }
    ...
    public function openSupportTicket()
    {
        ...
        return view(($this->userGuard ?? "Template::$this->userType") . '.support.create', compact('pageTitle', 'user'));
    }
    ...
    public function viewTicket($ticket)
    {
        ...
        return view(($this->userGuard ?? "Template::$this->userType") . '.support.view', compact('myTicket', 'messages', 'pageTitle', 'user', 'layout'));
    }
